...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'movie-genre',
        loadChildren: () =>
          import('../modules').then((m) => m.MovieGenreModule),
      },
      {
        path: 'sounder',
      ...
      {
        path: 'book',
        loadChildren: () => import('../modules').then((m) => m.BooksModule),
      },
      {
        path: 'book-file',
        loadChildren: () => import('../modules').then((m) => m.BookFileModule),
      },
      {
        path: 'user',
        loadChildren: () =>
          import('../modules').then((m) => m.UserClientModule),
      },
      {
        path: 'order',
